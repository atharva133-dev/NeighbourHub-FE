  ...
  return (
    <div className="glass-card rounded-2xl p-6">
      ...
      <button
        type="button"
        onClick={handleSave}
        className="mt-6 sm:mt-8 w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#6E8F73] to-[#C97B5A] px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-[#6E8F73]/25 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[#6E8F73]/40"
      >
