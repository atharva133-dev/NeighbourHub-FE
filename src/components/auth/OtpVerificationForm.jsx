  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="mt-4 text-xl font-bold text-slate-900">Verified!</p>
  ...
  return (
    <>
      ...
      <div className="mb-8 flex flex-col items-center text-center">
        <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#c026ff] to-[#3b82f6] shadow-lg shadow-indigo-500/30">
        ...
        <p className="mt-0.5 text-sm font-bold text-indigo-600 break-all">
          {email}
        </p>
      </div>
        ...
        <p className="text-sm font-medium text-slate-600">
          ...
          {cooldown > 0 ? (
            ...
            <button
              ...
              disabled={resending}
              className="font-bold text-indigo-600 transition hover:text-indigo-700 disabled:opacity-60"
            >
